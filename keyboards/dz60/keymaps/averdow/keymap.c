...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[DEFAULT] = LAYOUT_60_ansi(
		...
		KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI,          MO(LIGHTS),   KC_RCTL),

    [LIGHTS] = LAYOUT_60_ansi(
	...
	[CAT] = LAYOUT_60_ansi(
		KC_F21,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,           KC_F22,
		KC_NO,          KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_NO,          KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,  KC_NO, KC_NO, KC_NO,
		KC_NO,          KC_NO, KC_NO, KC_NO,  KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO,  KC_NO,  KC_NO,          KC_NO,
		KC_F23, KC_NO,          KC_NO,                   KC_NO,                            KC_NO, KC_NO,          KC_NO, KC_F24),
...
static uint8_t cat_swap_state = 0;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (keycode == MO(LIGHTS) || keycode == KC_DOWN) {
        if (record->event.pressed)
    ...
    if (keycode == KC_BSPC || keycode == KC_F22) {
        if (record->event.pressed)
            cat_swap_state |= 0b00000010;
        else
            cat_swap_state &= ~(0b00000010);
    }
    if (keycode == KC_LCTL || keycode == KC_F23) {
        if (record->event.pressed)
            cat_swap_state |= 0b00000100;
        else
            cat_swap_state &= ~(0b00000100);
    }
    if (keycode == KC_RCTL || keycode == KC_F24 || keycode == KC_DOWN) {
        if (record->event.pressed)
            cat_swap_state |= 0b00001000;
        else
            cat_swap_state &= ~(0b00001000);
    }
    if (cat_swap_state == 0b00001111) {
        layer_invert(CAT);
    }
